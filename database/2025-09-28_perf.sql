...
-- si vas a usar keyset pagination:
...
-- Opcional: cobertura para evitar heap fetch en listados frecuentes
-- CREATE INDEX IF NOT EXISTS idx_notif_user_unread_cov
-- ON notifications(user_id, is_read, created_at DESC)
-- INCLUDE (type, title, message, related_id);
